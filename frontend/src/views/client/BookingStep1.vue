...
.panel { background: var(--color-primary-tint); border-radius: 10px; padding: 14px; margin-top: 12px; }
.panel-header { font-size: 13px; color: var(--color-primary-ink); margin-bottom: 4px; }
.panel-time { font-size: 20px; font-weight: 700; color: var(--color-primary-ink); }
.panel-detail { font-size: 13px; color: var(--text-2); margin-top: 4px; }
.collision-checking { color: var(--text-3); font-size: 13px; margin-top: 8px; }
.collision-errors { margin-top: 8px; }
.err-item { color: var(--color-danger-ink); font-size: 13px; padding: 6px 10px; background: var(--color-danger-tint); border-radius: 8px; margin-bottom: 4px; }
.collision-ok { color: var(--color-success-ink); font-size: 13px; margin-top: 8px; }
.available-gaps { margin-top: 8px; display: flex; flex-wrap: wrap; align-items: center; gap: 4px; }
.gap-label { font-size: 12px; color: var(--text-3); }
.gap-tag { background: var(--color-mint-light); color: var(--color-success-ink); padding: 4px 10px; border-radius: 8px; font-size: 12px; }
